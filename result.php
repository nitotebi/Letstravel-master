...
<body style="background-color: #000000;">
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        <a class="navbar-brand heading" href="home.php?status=loggedin"><b>Du lịch</b></a>
        ...
        <div id="navbarNavDropdown" class="navbar-collapse collapse">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="nav-link" href="home.php?status=loggedin">Trang chủ</a>
                </li>
                <li class="nav-item">
    ...
    if(isset($_POST['GetResult']))
    {
        ...
        if(!empty($_POST['category']) || !empty($_POST['group']))
        {
            ...
            if($rows==0)
            {
                ...
                <div class="info">
                    <p style="color: #fafafa;">Xin lỗi tôi không tìm ra địa điểm nào phù hợp cho bạn :(. Ấn  <a href="home.php?status=loggedin">đây</a> để trở về trang chủ </p>
                </div>
            </div>';
            }
        }
