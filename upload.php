...
if(isset($_POST['create'])){
  ...
  $start=0;
	$sql="INSERT INTO trip (TripId,Image,BasePrice,Status,StartDate,EndDate,CreatedBy,GuideName,GuideContact) VALUES ('".$tripId."','".$tnName."',".$basePrice.",".$status.",'".$startDate."','".$endDate."','".$createdBy."','".$tgName."','".$tgCont."')";
...
if(isset($_POST['JoinTrip'])){
 ...
 $passCount = $_POST['passengerCount'];
  ...
  $sql1=  "INSERT into join_trip VALUES('".$email."','".$tripId."','".$fname."','".$lname."',".$age.",'".$gender."',".$contact.")";
  ...
  $sql="INSERT into user_pref VALUES ('".$email."','".$from_loc."','".$accom_pref."','".$travel_pref."')";
  ...
  if ($conn->query($sql) === TRUE) 
        ...
        <input class="form-check-input yellowBtn bottomBtn" type="submit" name="PayTrip" value="Đặt tour thành công.Quay về trang chủ" style="background-color: #ffc312;
            border: none;
            width: 30%;
            border-radius: 5px;
            color: white;
