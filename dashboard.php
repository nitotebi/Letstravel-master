  ...
  <!-- Modal content -->
    ...
    <form action="upload.php" method="POST" enctype="multipart/form-data">
    	<div style="margin-bottom: 6%;">
    		...
    		<label><h3 style="font-family: 'Montserrat', sans-serif;">Tạo tour mới</h3></label>
    	</div>
    	<div class="form-group row">
    		<label class="col-sm-4">Chọn địa điểm</label>
      ...
      <div class="form-group row">
        <label class="col-sm-4">Chọn địa điểm khởi đầu</label>
        <!--<i class="material-icons md-36 col-sm-1">location_on</i>-->
        <div class="col-sm-6">      
            <select name="start" class="label ui selection fluid dropdown" id="start">
            <option value="" disabled selected>Địa điểm khởi đầu</option>
          </select>
        </div>    
      </div>
  		<div class="form-group row">
        ...
        <div class="form-group row">
		    <label class="col-sm-4 ">Giá tour</label>
  		...
  		<div class="form-group row">
    		<label class="col-sm-4">Hướng dẫn tour</label>
  		...
  		<div class="form-group row">
    		<label  class="col-sm-4">Liên hệ hướng dẫn tour</label>
  		...
  		<div class="form-group row">
    		<label  class="col-sm-4">Ảnh</label>
    		<div class="col-sm-8"> 
    			<div class='input-group'>     
  		...
  		<!--<div class="form-group row">
    		<label class="col-sm-4 col-form-label">Hành trình</label>
    		<div class="col-sm-8">
    			<div class='input-group'>      
  		...
  		<div class="modal-footer">        
	        <button type="submit" class="yellowBtn createBtn" name="create">Tạo</button>
      	</div>
      </form>
    </div>
</div>
  ...
  <!--create trip card-->
    <a href="#createTripModal" onclick="javascript:openCreateTripModal();">
        <div class="col-sm-3">
          ...
          <div class="container">
            <h4 class="card-title"><b>TẠO TOUR DU LỊCH</b></h4> 
          </div>
        </div>
      </div>
  </a>
    ...
    <a href="#TripModal<?php echo $i;?>" onclick="javascript:openModal('<?php echo $i; ?>');" id="viewTripModal<?php echo $i;?>">
        <div class="col-sm-3">
          ...
          <div class="card-body">
            ...
            <p class="card-text">Khởi hành từ <?php echo $sloc; ?></p>
          </div> 
          </div>
      </div>
  </a>
  ...
  <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body" id="carouselimg">
            ...
            <div class="modalText">
              <label><b>Ngày:</b><?php echo $tripID['StartDate']; ?> tới <?php echo $tripID['EndDate']; ?></label><br>
              <!--<a href="uploads/<?php echo $tripID['Itinerary']; ?>" download class="downloadFile">Download itinerary</a><br>-->
              <label><b>Giá tour:</b> <?php echo $tripID['BasePrice']; ?>đ</label><br>
              <label><b>Hướng dẫn tour:</b><?php echo $tripID["GuideName"]; ?></label><br>
              <label><b>SĐT hướng dẫn tour:</b><?php echo $tripID["GuideContact"]; ?></label>
          </div>   
        </div>
        <div class="modal-footer">
          <form action="#" method="POST" enctype="multipart/form-data">
            <button type="submit" class="yellowBtn delBtn" value="<?php echo $tripID["TripId"];?>" name="deleteTrip">Xóa tour</button>
...
if(isset($_POST['deleteTrip']))
{
    ...
    if($resultx == True)
    {
    	echo "<script type='text/javascript'>alert('Xóa thành công'); window.location='dashboard.php'</script>";	
    	$email = "admin"; //replace email
	    ...
	    $mail->Subject = "Rất xin lỗi";
	    $mail->Body = "Dear ".$namem.",<br>Xin lỗi tour ".$locs12." đã bị hủy. Rất xin lỗi vì sự bất tiện này.";  
