  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    ...
    <div id="navbarNavDropdown" class="navbar-collapse collapse">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item">
          <a class="nav-link" href="home.php?status=loggedin">Trang chủ <span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="home.php?status=loggedin#Upcoming">Tour sắp tới</a>
        </li>
...
<!--             <a class="dropdown-item" href="#">Edit Profile</a> -->
  ...
  <!--main form-->
    ...
    <div class="topButtons">
      <label class="form-check-label" for="Pcount">Số hành khách</label>
      <input type="number" name="passengerCount" min="1" id="Pcount" value="1">
       <a id="iniPCount" onclick="tablerows()" class="yellowBtn">OK</a>
      <a id="addbtn" onclick="addRow()" class="linkBtn">+ Thêm</a>
    </div>
    <table class="table" id="passengertable">
      <thead class="thead-dark">
        <tr>
          ...
          <th scope="col"><input type="reset" value="Xóa" class="linkBtn"></th>
        </tr>
      </thead>
      <tbody>
        <td><?php                            
        ...
        <td><select name='gender0'><option>Chọn</option><option>Nam</option><option>Nữ</option></select></td>
        <td><?php                            
            ...
            {                              
          		echo "<input type='text' name='contact0' maxlength='20' pattern='([0-9]{10})' value='".$row['Mobile']."'>";
          	}
    ...
    <div class="form-group row">
      <label for="Locations" class="col-xl-3 col-form-label">Khởi hành từ</label>
      <div class="col-xl-9">
    ...
    <div class="form-group row ">
      <label for="accpref" class="col-xl-3 col-form-label">Chất lượng dịch vụ</label>
      <div id="accpref" class="col-xl-9">
        <div class="form-check form-check-inline">
          ...
          <label class="form-check-label" for="3star">Bình thường</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="accpref" id="5star" value="5star" onchange="javascript:getcost();">
          <label class="form-check-label" for="5star">Hạng sang</label>
        </div>
      </div>
    </div>
    <!--<div class="form-group row ">
    ...
    <div class="form-group row price">
      ...
      <div class="tnc" style="display: block;">
        <p id="tncText" style="padding: 0%; margin: 0; margin-bottom: 1%;">*Các chi phí được đề cập ở trên chỉ bao gồm giá cơ bản của chuyến đi , không bao gồm chi phí ăn ở và đi lại từ thành phố của bạn.</p>
      </div>
    </div>
    <!--<div class="form-group row">
    ...
    <div class="form-group row col-md-12" class="foot">
      <div class="form-check form-check-inline col-md-5">
        <a href="home.php?status=loggedin"><button onclick="" class="secondaryBtn">Hủy</button></a>
      </div>
      <div class="form-check form-check-inline col-md-5 confirmBtn">
        ...
        <input class="form-check-input yellowBtn bottomBtn" type="submit" name="JoinTrip" value="Thực hiện">
      </div>
    </div>
    </form>
  </div>
...
<script>
  ...
  document.getElementById("total").innerHTML = "Tổng tiền " + (cost1+cost2+cost3)*passengers+"đ*";
...
function tablerows(){
  ...
  function addRow(){
   var row1 = document.getElementById('passengertable').insertRow();
    ...
    gender1.innerHTML = "<select name='gender"+(passengers)+"'><option>Chọn</option><option>Nam</option><option>Nữ</option></select>";
